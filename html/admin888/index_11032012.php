...
if(trim($_SERVER['HTTP_HOST'])=='www.motorclubexperience.com' || trim($_SERVER['HTTP_HOST'])=='motorclubexperience.com' )
{
header('location:http://lon.motorclubexperience.com/admin888/');
}
