...
echo '<span class="calendario"><a href="javascript:ano_sel(\'-\',id_(\'ciudad_origen\').value,\''.$_REQUEST['tipus'].'\')">  <img src="'.URL_ROOT.'img/esquerra.gif"  alt="" /> </a>'.$ano.'<a href="javascript:ano_sel(\'+\',id_(\'ciudad_origen\').value,\''.$_REQUEST['tipus'].'\')">  <img src="'.URL_ROOT.'img/dreta.gif"  alt="" /> </a></span>'; // COLOCAR EL MES
...
echo '<span class="calendario"><a href="javascript:mes_sel(\'-\',id_(\'ciudad_origen\').value,\''.$_REQUEST['tipus'].'\')">  <img src="'.URL_ROOT.'img/esquerra.gif"  alt="" /> </a> '.strtoupper($_MESES['cas'][$mes-1]).' <a href="javascript:mes_sel(\'+\',id_(\'ciudad_origen\').value,\''.$_REQUEST['tipus'].'\')">  <img src="'.URL_ROOT.'img/dreta.gif"  alt="" /> </a> </span>'; // COLOCAR EL MES
