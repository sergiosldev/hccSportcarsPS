...
function descarga_emails_sel_barcelona(tipo_ferrari,tipo_lambo,tipo_porsche,tipo_corvette,tipo_todos,fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
// alert(tipus_ev)    
  window.location="<?php echo($root);?>/admin888/tabs/scripts/descargar_mails_seleccion.php?emails_bcn=1&tipo_ferrari="+tipo_ferrari+"&tipo_lambo="+tipo_lambo+"&tipo_porsche="+tipo_porsche+"&tipo_corvette="+tipo_corvette+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+"&sel_cliente="+sel_cliente;                
}

function descarga_emails_sel_madrid(tipo_ferrari,tipo_lambo,tipo_porsche,tipo_corvette,tipo_todos,fdesde,fhasta,hdesde,hhasta,sel_cliente){
  window.location="<?php echo($root);?>/admin888/tabs/scripts/descargar_mails_seleccion.php?emails_mad=1&tipo_ferrari="+tipo_ferrari+"&tipo_lambo="+tipo_lambo+"&tipo_porsche="+tipo_porsche+"&tipo_corvette="+tipo_corvette+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+"&sel_cliente="+sel_cliente;
}

function descarga_emails_sel_valencia(tipo_ferrari,tipo_lambo,tipo_porsche,tipo_corvette,tipo_todos,fdesde,fhasta,hdesde,hhasta,sel_cliente){
  window.location="<?php echo($root);?>/admin888/tabs/scripts/descargar_mails_seleccion.php?emails_val=1&tipo_ferrari="+tipo_ferrari+"&tipo_lambo="+tipo_lambo+"&tipo_porsche="+tipo_porsche+"&tipo_corvette="+tipo_corvette+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+"&sel_cliente="+sel_cliente;
}

function descarga_emails_sel_andalucia(tipo_ferrari,tipo_lambo,tipo_porsche,tipo_corvette,tipo_todos,fdesde,fhasta,hdesde,hhasta,sel_cliente){
  window.location="<?php echo($root);?>/admin888/tabs/scripts/descargar_mails_seleccion.php?emails_and=1&tipo_ferrari="+tipo_ferrari+"&tipo_lambo="+tipo_lambo+"&tipo_porsche="+tipo_porsche+"&tipo_corvette="+tipo_corvette+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+"&sel_cliente="+sel_cliente;
}

function descarga_emails_sel_cantabria(tipo_ferrari,tipo_lambo,tipo_porsche,tipo_corvette,tipo_todos,fdesde,fhasta,hdesde,hhasta,sel_cliente){
  window.location="<?php echo($root);?>/admin888/tabs/scripts/descargar_mails_seleccion.php?emails_can=1&tipo_ferrari="+tipo_ferrari+"&tipo_lambo="+tipo_lambo+"&tipo_porsche="+tipo_porsche+"&tipo_corvette="+tipo_corvette+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+"&sel_cliente="+sel_cliente;
}

function descarga_emails_sel_all(tipo_ferrari,tipo_lambo,tipo_porsche,tipo_corvette,tipo_todos,fdesde,fhasta,hdesde,hhasta,sel_cliente){
  window.location="<?php echo($root);?>/admin888/tabs/scripts/descargar_mails_seleccion.php?emails_all=1&tipo_ferrari="+tipo_ferrari+"&tipo_lambo="+tipo_lambo+"&tipo_porsche="+tipo_porsche+"&tipo_corvette="+tipo_corvette+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+"&sel_cliente="+sel_cliente;
}
...
function descarga_telefonos_all(tipoc,fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
  window.location="http://www.motorclubexperience.com/admin888/tabs/scripts/descargar_telefonos.php?telefons_all=1&tipoc="+tipoc+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;
}

function descarga_telefonos_barcelona(tipoc,fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
	window.location="http://www.motorclubexperience.com/admin888/tabs/scripts/descargar_telefonos.php?telefons_bcn=1&tipoc="+tipoc+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;
}

function descarga_telefonos_madrid(tipoc,fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
  window.location="http://www.motorclubexperience.com/admin888/tabs/scripts/descargar_telefonos.php?telefons_mad=1&tipoc="+tipoc+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;
}

function descarga_telefonos_valencia(tipoc,fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
  window.location="http://www.motorclubexperience.com/admin888/tabs/scripts/descargar_telefonos.php?telefons_val=1&tipoc="+tipoc+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;
}

function descarga_telefonos_andalucia(tipoc,fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
  window.location="http://www.motorclubexperience.com/admin888/tabs/scripts/descargar_telefonos.php?telefons_and=1&tipoc="+tipoc+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;
}

function descarga_telefonos_cantabria(tipoc,fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
	  window.location="http://www.motorclubexperience.com/admin888/tabs/scripts/descargar_telefonos.php?telefons_can=1&tipoc="+tipoc+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;
}
