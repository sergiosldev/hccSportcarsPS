   <table>
	   ...
	   <tr>
		<td><span class="label_">Prov&iacute;ncia</span><span style="color:#f00" >*</span></td>
		<td>
			<select multiple name="provincias[]" id="provincia">
				<?php
				
				$s=ProvinciaCiudad::getProvinciasCiudades();
						
				echo('<option value="0">Todas</option>');
				foreach($s as $r)
				{
					echo('<option value="'.$r['id_provincia_ciudad'].'">'.$r['nombre'].'</option>');
				}
	...
	-->
	   ...
	   <tr><td colspan="2" height="10px;"></td></tr>
	   <tr>
		<td><span class="label_">Ubicaciones</span><span style="color:#f00" ></span></td>
		<td>
		<div class="lang_3" style="display:block;float: left;">                        
			<textarea  style="width:600px;height:500px;" wrap="hard" class="rte" rows="10" cols="80" id="ubicaciones" name="ubicaciones"></textarea>
		</div>
			</td>
	   </tr>
	   <tr><td colspan="2" height="10px;"></td></tr>
	   ...
	   <tr><td colspan="2" height="10px;"></td></tr>
	   <tr>
		<td><span class="label_">Link Video GT</span></td> 
		<td>
		<div class="lang_3" style="display:block;float: left;">                        
			<input style="width:590px;" type="text" id="link_video_oferta_GT" name="link_video_oferta_GT">
		</div>
		</td>
	   </tr>
	   <tr><td colspan="2" height="10px;"></td></tr>
	   <tr>
		<td><span class="label_">Link Video GT 2 </span></td> 
		<td>
		<div class="lang_3" style="display:block;float: left;">                        
			<input style="width:590px;" type="text" id="link_video_oferta_GT2" name="link_video_oferta_GT2">
		</div>
		</td>
	   </tr>
	   <tr>
