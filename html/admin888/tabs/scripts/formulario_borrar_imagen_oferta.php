<div id="borrar_imagen_oferta" style="display:none;float:left;width:100%;" >
    <div id='form_borrar_imagen_oferta' style='text-align:left;padding:10px; background:#fff;'>
    <fieldset>
    <legend>Eliminar Imagen </legend>
    <div id="msg_error_im_of"></div>  
    <FORM ACTION="javascript:;" onsubmit="envia_form_borrar_imagen_oferta(id_('id_imagen_fbi').value,id_('id_oferta_fbi').value,id_('password').value)" METHOD="POST" id="frm_borrar_imagen_oferta" name="frm_borrar_imagen_oferta">
          <table >
           ...
           <input type="hidden" id="id_imagen_fbi" name="id_imagen_fbi">
           <input type="hidden" id="id_oferta_fbi" name="id_oferta_fbi">
    </FORM> 
    </fieldset>
    </div>
</div>
