...
$base_uri = "http://www.motorclubexperience.com";
...
<!--                    <FORM ACTION="tabs/scripts/calculo_lineas.php" target="frame_oferta" METHOD="POST" id="form_alta_oferta" name="form_alta_oferta">-->
    ...
    <!-- envia_formulari_oferta(); -->
                        <table>
						      <tr>
								<td align="right" style="padding-bottom:10px;"> <INPUT id="guardar_oferta_ca" TYPE="submit" class="boto" value="Guardar" onclick="submit_form_oferta();"> </td>
							  </tr>	
                              <tr><td align="left" valign="top">
                               <table >
                                ...
                                <td><br><textarea  NAME="titulo_ca" id="titulo_ca" class="input" style="width:98.5%;resize:none;"  rows="3" value=""></textarea></td>
                               </tr>
                               ...
                               <tr>
                                ...
                                <td><textarea NAME="subtitulo_ca" id="subtitulo_ca" class="input"  style="width:98.5%;resize:none;"  rows="3" value=""></textarea></td>
                               </tr>
                               ...
                               <tr>
                                ...
                                <td><INPUT TYPE="text" NAME="idinterno_ca" id="idinterno_ca" class="input" style="width:98.5%;resize:none;" value=""></td>
                               </tr>
                               ...
                               <tr>
                                ...
                                <div class="lang_3" style="display:block;float: left;">                        
                                    <textarea type="text"  style="width:600px;height:500px;" wrap="hard" class="rte"  id="destacados_ca" name="destacados_ca"></textarea>
                                </div>
                                <!-- rows="10" cols="80" -->
                                </td>
                               </tr>
                               ...
                               <tr>
                                ...
                                <td>
                                <div class="lang_3" style="display:block;float: left;">                        
                                    <textarea   style="width:600px;height:500px;" wrap="hard" class="rte" rows="20" cols="80" id="condiciones_ca" name="condiciones_ca"></textarea>
                                </div>
                                </td>
                               </tr>
                               ...
                               <tr>
                                ...
                                <td>
                                <div class="lang_3" style="display:block;float: left;">                        
                                    <textarea   style="width:600px;height:800px;"  wrap="hard" class="rte desc" rows="25" cols="80" id="descripcion_ca" name="descripcion_ca"></textarea>
                                </div>
                                </td>
                               </tr>
                               <tr><td colspan="2" height="10px;"></td></tr>
...
-->
                               <tr>
                                ...
                                <td>
                                <div class="lang_3" style="display:block;float: left;">                        
                                    <textarea  style="width:600px;height:500px;" wrap="hard" class="rte" rows="20" cols="80" id="descripcion_cupones_ca" name="descripcion_cupones_ca"></textarea>
                                </div>
                                </td>
                               </tr>
                               <tr><td colspan="2" height="10px;"></td></tr>
...
?>            
                       ...
                       <tr>
                           <td>
                               <table width="100%">
                                   <tr>
                                       <td aligh="left" style="padding-bottom:10px;"><INPUT id="boton_vista_previa_ca" style="visibility:hidden;" TYPE="button" class="boto" value="Vista Previa Cupón" onclick="ver_vista_previa_cupon();" ></td>  
                                       <td aligh="left" style="padding-bottom:10px;"><INPUT id="boton_vista_oferta_ca" style="visibility:hidden;" TYPE="button" class="boto" value="Vista Previa Oferta" onclick="ver_vista_previa_oferta();" ></td>  
                                       <td aligh="left" style="padding-bottom:10px;"><INPUT id="boton_vista_previa_ca2" style="visibility:hidden;" TYPE="button" class="boto" value="Vista Previa Cupón" onclick="ver_vista_previa_cupon_test();" ></td>  
                   ...
                   <div id="step2_ca" class="tab-page" style="display: none;">
                       <?php include_once (dirname(__FILE__).'/formulario_imagenes_oferta_ca.php');?> 
                   </div>
           </div><!-- fin tab_panel -->  
            </fieldset>
...
<script>
    ...
    function ver_vista_previa_cupon()
    {
        var ale='&gg'+(Math.floor(Math.random()*50000))+'=1';
        //id_('form_cupon_pdf').action='../../../../scripts/generar_pdf_cupon_ca.php?id_oferta='+id_('idoferta_ca').value+'&vista_previa=1'+ale;

        id_('form_cupon_pdf').action='../generar_vista_previa_cupon_alfa.php?id_oferta='+id_('idoferta_ca').value+'&id_distribuidor='+ale;
    ...
    function ver_vista_previa_oferta()
    {
        var ale='&gg'+(Math.floor(Math.random()*50000))+'=1';
        //id_('form_cupon_pdf').action='../../../../scripts/generar_pdf_cupon_ca.php?id_oferta='+id_('idoferta_ca').value+'&vista_previa=1'+ale;
		r=ajax_post.load('<?php echo $base_scripts_ca ?>/ajax_acceso_ofertas_prestashop.php?a=1'+ale);
        id_('form_cupon_pdf').action='<?php echo($base_uri);?>/detalle-oferta-dist/'+id_('idoferta_ca').value+'-1-oferta.html';
