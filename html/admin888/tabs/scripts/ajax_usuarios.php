...
//mts 05052012. Fichero ajax para la inserción y modificación de cupones.
    ...
    {  
        ...
        {   
			...
			$cad_eval.='id_(\'nif_oferta\').value=\''. $usu->nif.'\'; ';
            ...
            $cad_eval.='id_(\'direccion_oferta\').value=\''. $usu->direccion.'\'; ';       
    ...
    else if (isset($_GET['modifica_usuario']))
    {
        ...
        $direccion=$_GET['direccion_oferta'];
		$nif=$_GET['nif_oferta'];
        $ciudad=$_GET['ciudad'];
        $cpostal=$_GET['cpostal'];
        $telefono=$_GET['telefono'];
        $usu = new UsuarioHCC($id_usuario,$email,$password,$nombre, $apellidos, $fecha_nacimiento, 
