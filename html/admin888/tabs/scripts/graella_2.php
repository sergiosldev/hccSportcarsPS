...
// fi graelles dobles
    ...
    if(mysql_num_rows($result)) { // plaza ocupada
	  ...
	  $info='
        ...
        -->
        <td  width="15%" class="borderg " align="left" style="color:#f22;font-weight:bold" > '.$r['mobil_persona_regala'].' </td>
        <td  width="17%" class="borderg " align="left" > '.$r['Observaciones'].' </td>
        <td  width="12%" class="borderg " align="left" > Localizador:<br>
        <span class="codigos">'.$r['codi_localtzador'].'</span><br>
         Consumo:<br><span class="codigos">'.$r['codi_consum'].'</span></td>
         <td align="right" valign="center" ><a id="activa" href="javascript:esborra(\''.$r['id'].'\',\''.TEMPS.'@'.$hora.'\')">
         ...
         if($r['marcat']=='1')
           $info.='<a class="_marcat" style=" background: none repeat scroll 0% 0% #f00; border: 0px solid #000; padding: 1px;" href="javascript:marca_event(\''.$r['id'].'\',0)">&nbsp;&nbsp;</a>';
         else
           $info.='<a class="_marcat" style=" background: none repeat scroll 0% 0% #0f0; border: 0px solid #000; padding: 1px;" href="javascript:marca_event(\''.$r['id'].'\',1)">&nbsp;&nbsp;</a>';

         $info.='
         <a id="activa" href="javascript:email(\''.$r['id'].'\',\''.TEMPS.'@'.$hora.'\')">   
             <img src="'.URL_ROOT.'img/email.png" width="22px"  alt=""  />
         </a>
         <div style="display:inline;width:10px;position:absolute;padding-top:3px;margin-left:2px">
		 ...
		 {
		 $info.=  
		 '<a id="activa" href="javascript:form_reubicar(\''.$_REQUEST['ciudad'].'\',\''.$_REQUEST['tipus'].'\',\''.TEMPS.'@'.$hora_bona.'\')">  
             Reubicar
			</a>';
		 }
		 $info.='</td>
