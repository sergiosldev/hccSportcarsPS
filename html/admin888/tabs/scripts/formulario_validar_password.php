...
<div id="validar_password" style="display:none;float:left;width:100%;" >
    ...
    <FORM ACTION="javascript:;" onsubmit="envia_formulario_validar_password (id_('archivo_operacion').value,id_('archivo_retorno').value,id_('datos').value,id_('div_retorno').value,id_('ancho_div_retorno').value,document.frm_validar_password.password_.value)" METHOD="POST" id="frm_validar_password" name="frm_validar_password">
          <table >
            ...
            <tr>
                ...
                <td><br><INPUT TYPE="password" NAME="password_" id="password_"></td>
