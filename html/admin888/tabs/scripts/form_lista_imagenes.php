...
//include dirname(__FILE__).'/../../../classes/ImagenOferta.php'; 
...
<table cellspacing="0" cellpadding="0" class="table">
      ...
      <?php
        $id_oferta=tools::getValue('id_oferta'); 
		$id_imagen=tools::getValue('imagen');
        //$im = new ImagenOferta($id_oferta,3);
		$im = new ImagenOferta($id_imagen,3,$id_oferta);
		//echo('Okim: ');var_dump($im);die;
