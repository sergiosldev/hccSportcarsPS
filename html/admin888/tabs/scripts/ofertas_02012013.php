    ...
    <div id="ofertas">  
        ...
        ?>
         ...
         <?php  if ($o->activa==0 and !$procesando_inactivas)
           ...
           ?>
           <tr>
           <td  colspan="8" style = "text-align:left;" class="cabecera_oferta">Campañas Inactivas</td>
           </tr>
           <?php
           ...
           <tr style="height:33px;vertical-align:top;" <?php echo($class);?>>   
               ...
               ?>
               <td width="25%" colspan="2" style = "text-align:left;" class="cabecera_oferta">Campaña del día &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#3399FF;"><?php echo($d.'/'.$m.'/'.$y.' '.substr($o->fechaInicio,11));?></span>  </td>
           ...
           <tr>
               ...
               <td width="15%" class="texto_oferta" style="text-align:left;">
                   <table>
                       ...
                       <tr><td><div style="height:100px;width:200px;overflow:hidden;margin-bottom:10px;"><?php echo(utf8_encode(substr_without_tags($o->destacados,0,200,'...')));?></div></td></tr>
                   </table>
               </td>
               ...
               <td width="5%" class="texto_oferta valor_oferta">
                    <a title="Borrar la campaña" id="activa" href="javascript:borrar_oferta('<?php echo($o->id);?>',0)">
...
else 
{
    ...
    <div id="ofertas">  
        ...
        foreach($ofertas as $o)
          {
        ?>
           <?php $inactivo = ($inactivo=='inactivo_blanco')?'inactivo_gris':'inactivo_blanco';?>  
        <table>
        <tr>
        <td>
            <table  style="border:1px solid #CCCCCC;margin-left:12px;padding:7px;width:5%;">
               <tr>       
                   <td class="texto_cabecera" style="font-weight:bold">Vip</td>
               </tr>
               <tr>
                   <td width="10%" align="left" > <input type="button" class="boto boton_marcar" onclick="javascript:marca_cliente_especial('<?php echo($o->id);?>','1','<?php echo($o->clienteEspecial);?>')"></td> 
                </tr>
            </table>
        </td>
        <td>
            <table class="<?php echo(($o->clienteEspecial==1)?'activo':$inactivo);?>" style="height:71px;border:1px solid #CCCCCC;padding:7px;width:70%;">
               <tr>
                   <?php
                   $precio=floatval($o->precioValor);
                   if (floatval($o->descuento)!=0) $precio_oferta = floor(floatval($precio-$precio*$o->descuento/100));
                   ...
                   <td width="200px" align="left"> <input type="button"  style="width:70px;height:30px;" class="boto"  text="Editar oferta"  onclick="javascript:edita_menu_oferta('<?php echo($o->id);?>');" value="Editar"></td>
                   <td width="400px" align="left"  style="padding-left:50px;"><span class="texto_cabecera" style="height:30px;">Link</span>  <input onclick="copia_link('<?php echo($URL_ROOT.'/detalle-oferta/'.$o->id.'-1-oferta.html');?>');" type="text" readonly="readonly" style="width:400px;" text="Copiar link"  value='<?php echo($URL_ROOT.'/detalle-oferta/'.$o->id.'-1-oferta.html');?>'></td>
               </tr>
             </table> 
         </td>
         </tr>
