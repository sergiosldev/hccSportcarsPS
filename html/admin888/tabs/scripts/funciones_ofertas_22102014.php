...
function InsertOferta($inIdDesc,$inTitulo, $inSubtitulo, $inDestacados, $inCondiciones, $inDescripcion, $inPrecioValor,$inDescuento,$inAhorro,$inPrecioFinal,$inDescripcionCupones,$inMultipleCantidad,$inLinkVideo=null,$inLinkVideo2=null,$inIdTipoServicio=null,$inIdDescOpcion=null)
{          
    global $connection;
    $error = "";
    ...
    $sql = " insert into ps_oferta (id_oferta,orden,id_desc,id_desc_opcion,id_category_default,price,reduction_percent,active,reduction_price,final_price,realiza,descripcion_cupones,multiple_cantidad,link_video,link_video2,id_tipo_servicio) ";             
 
    $sql = $sql. " values (".$NewId.",".$NewOrden.",'".$inIdDesc."','".$inIdDescOpcion."',2,'".$inPrecioValor."','".$inDescuento."',0,'".$inAhorro."','".$inPrecioFinal."','".$inCondiciones."','".$inDescripcionCupones."','".$inMultipleCantidad."','".$inLinkVideo."','".$inLinkVideo2."','".$inIdTipoServicio."')";     
...
function InsertOfertaHistorico($inIdOferta,$inIdDesc,$inTitulo, $inSubtitulo, $inDestacados, $inCondiciones, $inDescripcion, $inPrecioValor,$inDescuento,$inAhorro,$inPrecioFinal,$inFechaInicio,$inFechaFin,$inActiva,$inDescripcionCupones,$inMultipleCantidad,$inClienteEspecial=null,$inLinkVideo=null,$inLinkVideo2=null,$inIdTipoServicio=null,$inMotorclub=null,$inDreamcars=null,$inHcc=null,$inIdDescOpcion=null)
{          
    global $connection;
    $error = "";
