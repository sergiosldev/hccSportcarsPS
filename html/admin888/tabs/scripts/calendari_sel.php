...
public function dia_libre($dia,$tipus)
{
    global $link;
...
echo '<span class="calendario"><a href="javascript:ano_sel(\'-\',ciudad_aux_sel,\''.$_REQUEST['tipus'].'\')">  <img src="'.URL_ROOT.'img/esquerra.gif"  alt="" /> </a>'.$ano.'<a href="javascript:ano_sel(\'+\',ciudad_aux_sel,\''.$_REQUEST['tipus'].'\')">  <img src="'.URL_ROOT.'img/dreta.gif"  alt="" /> </a></span>'; // COLOCAR EL MES
...
echo '<span class="calendario"><a href="javascript:mes_sel(\'-\',ciudad_aux_sel,\''.$_REQUEST['tipus'].'\')">  <img src="'.URL_ROOT.'img/esquerra.gif"  alt="" /> </a> '.strtoupper($_MESES['cas'][$mes-1]).' <a href="javascript:mes_sel(\'+\',ciudad_aux_sel,\''.$_REQUEST['tipus'].'\')">  <img src="'.URL_ROOT.'img/dreta.gif"  alt="" /> </a> </span>'; // COLOCAR EL MES
    ...
    {   
	 ...
	 if(in_array($ano.'-'.$aux_mes.'-'. $aux_i,dies_ocupats())){
		 	if(in_array($ano.'-'.$aux_mes.'-'. $aux_i,dies_ocupats_color())){
				$marcat='no_marcat'; $click='onclick="click_dia_sel(\''.$ano.'-'.$aux_mes.'-'. $aux_i.'\')"'; 
			}
			 ...
			 $dia_libre = $this->dia_libre($ano.'-'.$aux_mes.'-'.$aux_i,$_REQUEST['tipus']);
			 	
			 //die('dialibre: '.$dia_libre);
			 if (!$dia_libre && $marcat!='marcat_negre')
			 {
			     $marcat='marcat_lila'; $click='';
			 }
