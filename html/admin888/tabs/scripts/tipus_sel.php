...
<fieldset>
  <legend>Tipo evento</legend>	
	...
	<a id="_bferrari_" style="margin-right:10px;width:80px;"  class="boton_menu_tipo boton_mediano" href="javascript:actualizar_calendario_sel('_bferrari_')">Ferrari 7km</a>
	...
	<a id="_blamborghini_" style="margin-right:10;width:116px;"  class="boton_menu_tipo boton_grande"  href="javascript:actualizar_calendario_sel('_blamborghini_')">Lamborghini 7km</a>
	...
	<a id="_corvette_"  style="margin-right:10px;width:99px;"  class="boton_menu_tipo boton_mediano"  href="javascript:actualizar_calendario_sel('_corvette_')">Corvette 20km</a>
	<a id="_bcorvette_" style="margin-right:10px;"  class="boton_menu_tipo boton_mediano"  href="javascript:actualizar_calendario_sel('_bcorvette_')">Corvette 7km</a>
    <a id="_buggy_"  style="display:none;margin-right:10px;"  class="boton_menu_tipo boton_small"  href="javascript:actualizar_calendario_sel('_buggy_')">BUGGY</a>
...
<script>
	...
	id_('calendari_sel').innerHTML = crida_sel(v_mes_sel, v_ano_sel,ciudad_aux_sel,tipo);
