...
<FORM  target="iframeUpload" action="tabs/scripts/ofertas/ajax_imagen_oferta_bd.php<?php echo('?ale='.rand(0,50000));?>" METHOD="POST" id="form_alta_imagen" name="form_alta_imagen" enctype='multipart/form-data'>
