<div id="marcar_cliente_especial_oferta" style="display:none;float:left;width:100%;" >
    ...
    <FORM ACTION="javascript:;" onsubmit="envia_formulario_marcar_oferta(id_('id_oferta_fmce').value,id_('password').value,id_('creadas_fmce').value)" METHOD="POST" id="frm_marcar_cliente_especial" name="frm_marcar_cliente_especial">
          <table >
