<div id="desbloquear_cupon_oferta" style="display:none;float:left;width:100%;" >
    ...
    <FORM ACTION="javascript:;" onsubmit="envia_formulario_desbloquear_cupon_oferta(id_('id_oferta_fd').value,id_('ncupon_fd').value,id_('password').value,id_('creadas_fd').value)" METHOD="POST" id="frm_desbloquear_cupon_oferta" name="frm_desbloquear_cupon_oferta">
          <table >
