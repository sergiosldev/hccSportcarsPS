...
{
	global $link;
    if (!$err) return (mysqli_errno($link).'-'.mysqli_error($link));
    else return ($err);
}
...
function InsertOferta($inIdDesc,$inTitulo, $inSubtitulo, $inDestacados, $inCondiciones, $inDescripcion, $inPrecioValor,$inDescuento,$inAhorro,$inPrecioFinal,$inDescripcionCupones,$inMultipleCantidad,$inLinkVideo=null,$inLinkVideo2=null,$inIdTipoServicio=null,$inIdDescOpcion=null,$inLinkVideoDreamcars=null,$inLinkVideoDreamcars2=null,$inLinkVideoHcc=null,$inLinkVideoHcc2=null)     
{          
    global $link;
    $error = "";
    ...
    $sql = " insert into ps_oferta (id_oferta,orden,id_desc,id_desc_opcion,id_category_default,price,reduction_percent,active,reduction_price,final_price,realiza,descripcion_cupones,multiple_cantidad,link_video,link_video2,id_tipo_servicio,link_video_dreamcars,link_video2_dreamcars,link_video_hcc,link_video2_hcc) ";                                                                
 
    $sql = $sql. " values (".$NewId.",".$NewOrden.",'".$inIdDesc."','".$inIdDescOpcion."',2,'".$inPrecioValor."','".$inDescuento."',0,'".$inAhorro."','".$inPrecioFinal."','".$inCondiciones."','".$inDescripcionCupones."','".$inMultipleCantidad."','".$inLinkVideo."','".$inLinkVideo2."','".$inIdTipoServicio."','".$inLinkVideoDreamcars."','".$inLinkVideoDreamcars2."','".$inLinkVideoHcc."','".$inLinkVideoHcc2."')";                                                                              
...
function InsertOfertaHistorico($inIdOferta,$inIdDesc,$inTitulo, $inSubtitulo, $inDestacados, $inCondiciones, $inDescripcion, $inPrecioValor,$inDescuento,$inAhorro,$inPrecioFinal,$inFechaInicio,$inFechaFin,$inActiva,$inDescripcionCupones,$inMultipleCantidad,$inClienteEspecial=null,$inLinkVideo=null,$inLinkVideo2=null,$inIdTipoServicio=null,$inMotorclub=null,$inDreamcars=null,$inHcc=null,$inIdDescOpcion=null,$inLinkVideoDreamcars=null,$inLinkVideoDreamcars2=null,$inLinkVideoHcc=null,$inLinkVideoHcc2=null)
{          
    global $link ;
    $error = "";
...
function UpdateOferta($inId, $inIdDesc=null,$inTitulo=null, $inSubtitulo=null, $inDestacados=null, $inCondiciones=null, $inDescripcion=null, $inPrecioValor=null,$inDescuento=null,$inAhorro=null,$inPrecioFinal=null,$inDescripcionCupones=null,$inMultipleCantidad=null,$inLinkVideo = null,$inLinkVideo2 = null,$inIdTipoServicio=null,$inIdDescOpcion=null,$inLinkVideoDreamcars=null,$inLinkVideoDreamcars2=null,$inLinkVideoHcc=null,$inLinkVideoHcc2=null)
{
