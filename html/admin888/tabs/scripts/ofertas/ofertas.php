...
if ($_GET['creadas']==0)
{
    ...
    <div id="ofertas">  
	   ...
	   $empresa = '';
	   $sep=' / ';
	   if ($o->motorclub==1) {$motorclub=1; $empresa.=(($empresa=='')?'':$sep).'MCE';}
	   if ($o->dreamcars==1) {$dreamcars=1;$empresa.=(($empresa=='')?'':$sep).'DREAM';}
         ...
         <table <?echo($class);?>  width="100%"  style="border:1px solid #CCCCCC;margin-left:12px;width:950px;padding:7px;">
           ...
           <tr>
               ...
               <td width="15%" class="texto_oferta" style="text-align:left;">
                   <table>
                       <tr><td  style='font-weight:bold;color:#3399FF;'><?php echo(utf8_encode($o->idDesc).' ['.$empresa.']');?></td></tr>
        ...
        <td>
            <table class="<?php echo(($o->clienteEspecial==1)?'activo':$inactivo);?>" style="margin-left:10px;height:71px;border:1px solid #CCCCCC;padding:7px;width:98%;">
               <tr>
				   ...
				   {
					   if ($o->motorclub==1) {$url_detalle='http://www.motorclubexperience.com/'.$url_detalle;}   
					   else if ($o->dreamcars==1) {$url_detalle='http://www.dreamcarsexperience.com/'.$url_detalle;}
					   else if ($o->hcc==1) {$url_detalle='http://www.hccsportcars.com/'.$url_detalle;}   
                  ...
                  ?> 
                   ...
                   <td width="184px" align="left"> <input type="button"  style="width:70px;height:30px;" class="boto"  text="Editar oferta"  onclick="javascript:edita_menu_oferta('<?php echo($o->id);?>','<?php echo($periodo);?>',0,'<?php echo($o->clienteEspecial);?>',<?php echo($motorclub);?>,<?php echo($dreamcars);?>,<?php echo($hcc);?>,<?php echo($periodo_automatico);?>);" value="Editar"></td>
