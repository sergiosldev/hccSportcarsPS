	...
	<FORM ACTION="javascript:;" onsubmit="envia_formulari_busqueda()" METHOD="POST" id="form_alta" name="form_alta">
    <table><tr><td align="left" valign="top">
		  <table >
		   ...
		   <tr>
		    ...
		    <td><INPUT TYPE="text" NAME="apellidos_piloto" id="apellidos_piloto"></td>
		   </tr>
		   <tr>
	   ...
	   <td align="left" valign="top">		   
		   ...
		   <tr>
		    ...
		    <td><INPUT TYPE="text" NAME="apellidos_persona_regala" id="apellidos_persona_regala"></td>
		   </tr>
		   <tr>
    ...
    <tr>
      <td  style="background:#ff0000;">
       ...
       <span class="label_g" style="color:#fff"> Lamborghini + Lotus </span>
			...
			<select id="origen" name="origen" data-valor="Origen" onchange="cambia_origen('{$base_dir_ssl}');">
            ...
            <td colspan="1"><INPUT TYPE="text"  NAME="fecha_reserva" id="fecha_reserva" disabled="disabled"> </td>
           </tr>		    <tr>
