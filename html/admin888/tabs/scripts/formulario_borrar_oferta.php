<div id="borrar_oferta" style="display:none;float:left;width:100%;" >
    ...
    <FORM ACTION="javascript:;" onsubmit="envia_formulario_borrar_oferta(id_('id_oferta_fbo').value,id_('password_ofe').value,id_('creadas_fbo').value,id_('tipo_oferta_fbo').value,id_('tipo_password_fbo').value)" METHOD="POST" id="frm_borrar_oferta" name="frm_borrar_oferta">
          <table >
            ...
            <tr>
                ...
                <td><br><INPUT TYPE="password" NAME="password" id="password_ofe"></td>
