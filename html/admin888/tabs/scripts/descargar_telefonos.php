...
//die('selcli '.$_REQUEST['sel_cliente']);
  ...
  {    
	  /*
	  $where1=' where ((length(trim(telefon)) = 9 and substr(trim(telefon),1,1)!=9) or  (length(trim(mobil_persona_regala)) = 9 and substr(trim(mobil_persona_regala),1,1)!=9))';
	  $where2=' where ((length(trim(telefon)) = 9 and substr(trim(telefon),1,1)!=9) or  (length(trim(mobil_persona_regala)) = 9 and substr(trim(mobil_persona_regala),1,1)!=9))';
	  $where3=' where ((length(trim(telefon)) = 9 and substr(trim(telefon),1,1)!=9) or  (length(trim(mobil_persona_regala)) = 9 and substr(trim(mobil_persona_regala),1,1)!=9))';
	  $where4=' where ((length(trim(telefon)) = 9 and substr(trim(telefon),1,1)!=9) or  (length(trim(mobil_persona_regala)) = 9 and substr(trim(mobil_persona_regala),1,1)!=9))';
	  $where5=' where ((length(trim(telefon)) = 9 and substr(trim(telefon),1,1)!=9) or  (length(trim(mobil_persona_regala)) = 9 and substr(trim(mobil_persona_regala),1,1)!=9))';
	*/
		  ...
		  if ($_REQUEST['tipo_ferrari']!='')     
			{
				if ($where12=='')
				{
				$where12=' and (e.tipus_event in ("_bferrari_","ferrari","_ferrari_","ferrari_porsche901") ';   
				$where22=' and (em.tipus_event in ("_bferrari_","ferrari","_ferrari_","ferrari_porsche901") ';   
				$where32=' and (ev.tipus_event in ("_bferrari_","ferrari","_ferrari_","ferrari_porsche901") ';       
				$where42=' and (ea.tipus_event in ("_bferrari_","ferrari","_ferrari_","ferrari_porsche901") ';    
				$where52=' and (ec.tipus_event in ("_bferrari_","ferrari","_ferrari_","ferrari_porsche901") ';       
				}
				else 
				{
				$where12.=' or e.tipus_event in ("_bferrari_","ferrari","_ferrari_","ferrari_porsche901") ';   
				$where22.=' or em.tipus_event in ("_bferrari_","ferrari","_ferrari_","ferrari_porsche901") ';   
				$where32.=' or ev.tipus_event in ("_bferrari_","ferrari","_ferrari_","ferrari_porsche901") ';       
				$where42.=' or ea.tipus_event in ("_bferrari_","ferrari","_ferrari_","ferrari_porsche901") ';    
				$where52.=' or ec.tipus_event in ("_bferrari_","ferrari","_ferrari_","ferrari_porsche901") ';       
				}
			}			
		  if ($_REQUEST['tipo_lambo']!='')   
			{
				if ($where12=='')
				{
				$where12=' and (e.tipus_event in ("_blamborghini_","lamborghini","_lamborghini_","lamborghini_lotus") ';   
				$where22=' and (em.tipus_event in ("_blamborghini_","lamborghini","_lamborghini_","lamborghini_lotus") ';   
				$where32=' and (ev.tipus_event in ("_blamborghini_","lamborghini","_lamborghini_","lamborghini_lotus")';       
				$where42=' and (ea.tipus_event in ("_blamborghini_","lamborghini","_lamborghini_","lamborghini_lotus") ';    
				$where52=' and (ec.tipus_event in ("_blamborghini_","lamborghini","_lamborghini_","lamborghini_lotus") ';       
				}
				else 
				{
				$where12.=' or e.tipus_event in ("_blamborghini_","lamborghini","_lamborghini_","lamborghini_lotus") ';   
				$where22.=' or em.tipus_event in ("_blamborghini_","lamborghini","_lamborghini_","lamborghini_lotus") ';   
				$where32.=' or ev.tipus_event in ("_blamborghini_","lamborghini","_lamborghini_","lamborghini_lotus") ';       
				$where42.=' or ea.tipus_event in ("_blamborghini_","lamborghini","_lamborghini_","lamborghini_lotus") ';    
				$where52.=' or ec.tipus_event in ("_blamborghini_","lamborghini","_lamborghini_","lamborghini_lotus") ';       
				}
			}			
		  if ($_REQUEST['tipo_porsche']!='')   
			{
				if ($where12=='')
				{
				$where12=' and (e.tipus_event in ("_bporsche_","_porsche_","porsche","porsche997","porsche996") ';   
				$where22=' and (em.tipus_event in ("_bporsche_","_porsche_","porsche","porsche997","porsche996") ';   
				$where32=' and (ev.tipus_event in ("_bporsche_","_porsche_","porsche","porsche997","porsche996")';       
				$where42=' and (ea.tipus_event in ("_bporsche_","_porsche_","porsche","porsche997","porsche996") ';    
				$where52=' and (ec.tipus_event in ("_bporsche_","_porsche_","porsche","porsche997","porsche996") ';       
				}
				else 
				{
				$where12.=' or e.tipus_event in ("_bporsche_","_porsche_","porsche","porsche997","porsche996") ';   
				$where22.=' or em.tipus_event in ("_bporsche_","_porsche_","porsche","porsche997","porsche996") ';   
				$where32.=' or ev.tipus_event in ("_bporsche_","_porsche_","porsche","porsche997","porsche996") ';       
				$where42.=' or ea.tipus_event in ("_bporsche_","_porsche_","porsche","porsche997","porsche996") ';    
				$where52.=' or ec.tipus_event in ("_bporsche_","_porsche_","porsche","porsche997","porsche996")';             
				}
			}			
		  ...
		  if ($_REQUEST['tipo_corvette']!='')   
			{
				if ($where12=='')
				{
				$where12=' and (e.tipus_event in ("_bcorvette_","_corvette_","corvette") ';   
				$where22=' and (em.tipus_event in ("_bcorvette_","_corvette_","corvette") ';   
				$where32=' and (ev.tipus_event in ("_bcorvette_","_corvette_","corvette")';       
				$where42=' and (ea.tipus_event in ("_bcorvette_","_corvette_","corvette") ';    
				$where52=' and (ec.tipus_event in ("_bcorvette_","_corvette_","corvette") ';       
				}
				else 
				{
				$where12.=' or e.tipus_event in ("_bcorvette_","_corvette_","corvette") ';   
				$where22.=' or em.tipus_event in ("_bcorvette_","_corvette_","corvette") ';   
				$where32.=' or ev.tipus_event in ("_bcorvette_","_corvette_","corvette") ';       
				$where42.=' or ea.tipus_event in ("_bcorvette_","_corvette_","corvette") ';    
				$where52.=' or ec.tipus_event in ("_bcorvette_","_corvette_","corvette")';       
				}
			}			
	 }	
	  ...
	  SELECT pilot,telefon,persona_regala,mobil_persona_regala from events e '.$where1.'
	  UNION ALL
	  SELECT pilot,telefon,persona_regala,mobil_persona_regala from eventsmadrid em '.$where2.' 
	  UNION ALL
	  SELECT pilot,telefon,persona_regala,mobil_persona_regala from eventsvalencia ev '.$where3.' 
	  UNION ALL
	  SELECT pilot,telefon,persona_regala,mobil_persona_regala from eventsandalucia ea '.$where4.' 
	  UNION ALL
	  SELECT pilot,telefon,persona_regala,mobil_persona_regala from eventscantabria ec '.$where5.'         
	  ';		
...
elseif(isset($_REQUEST['telefons_bcn']))
  {
  //$where = ' where ((length(trim(telefon)) = 9 and substr(trim(telefon),1,1)!=9) or  (length(trim(mobil_persona_regala)) = 9 and substr(trim(mobil_persona_regala),1,1)!=9))';
    ...
    if ($_REQUEST['tipo_todos']=='')     
	  ...
	  if ($_REQUEST['tipo_ferrari']!='')     
		{	
			if ($where2=='')
			{
				$where2=' and ( tipus_event in ("_bferrari_","ferrari","_ferrari_","ferrari_porsche901") ';   
			}
			else 
			{
				$where2.=' or tipus_event in ("_bferrari_","ferrari","_ferrari_","ferrari_porsche901") ';   
			}
		}			
	  if ($_REQUEST['tipo_lambo']!='')   
		{
			if ($where2=='')
			{
				$where2=' and ( tipus_event in ("_blamborghini_","lamborghini","_lamborghini_","lamborghini_lotus") ';   
			}
			else 
			{
				$where2.=' or tipus_event in ("_blamborghini_","lamborghini","_lamborghini_","lamborghini_lotus") ';   
			}
		}
	  if ($_REQUEST['tipo_porsche']!='')   
		{
			if ($where2=='')
			{
				$where2=' and ( tipus_event in ("_bporsche_","_porsche_","porsche","porsche997","porsche996") ';   
			}
			else 
			{
				$where2.=' or tipus_event in ("_bporsche_","_porsche_","porsche","porsche997","porsche996") ';   
			}
		}
	  ...
	  if ($_REQUEST['tipo_corvette']!='')   
		{
			if ($where2=='')
			{
				$where2=' and ( tipus_event in ("_bcorvette_","_corvette_","corvette") ';   
			}
			else 
			{
				$where2.=' or tipus_event in ("_bcorvette_","_corvette_","corvette") ';   
			}
		}
  ...
  $sql='
  SELECT pilot,telefon,persona_regala,mobil_persona_regala   from events '.$where.' 
  ';
  //die($sql);
  $result=mysqli_query($link,$sql);
}

elseif(isset($_REQUEST['telefons_mad']))
  {
  //$where = ' where ((length(trim(telefon)) = 9 and substr(trim(telefon),1,1)!=9) or  (length(trim(mobil_persona_regala)) = 9 and substr(trim(mobil_persona_regala),1,1)!=9))';
  $where=' where (substr(trim(telefon),1,1)!=9 or substr(trim(mobil_persona_regala),1,1)!=9)';
  ...
  $sql='
  SELECT pilot,telefon,persona_regala,mobil_persona_regala   from eventsmadrid '.$where.'
  ';
  //die($sql);
  $result=mysqli_query($link,$sql);
}
elseif(isset($_REQUEST['telefons_val']))
  {
  //$where = ' where ((length(trim(telefon)) = 9 and substr(trim(telefon),1,1)!=9) or  (length(trim(mobil_persona_regala)) = 9 and substr(trim(mobil_persona_regala),1,1)!=9))';
  $where=' where (substr(trim(telefon),1,1)!=9 or substr(trim(mobil_persona_regala),1,1)!=9)';
  ...
  $sql='
  SELECT pilot,telefon,persona_regala,mobil_persona_regala  from eventsvalencia '.$where.'
  ';

  $result=mysqli_query($link,$sql);
}
elseif(isset($_REQUEST['telefons_and']))
  {
  //$where = ' where ((length(trim(telefon)) = 9 and substr(trim(telefon),1,1)!=9) or  (length(trim(mobil_persona_regala)) = 9 and substr(trim(mobil_persona_regala),1,1)!=9))';
  $where=' where (substr(trim(telefon),1,1)!=9 or substr(trim(mobil_persona_regala),1,1)!=9)';
...
elseif(isset($_REQUEST['telefons_can']))
  {
  //$where = ' where ((length(trim(telefon)) = 9 and substr(trim(telefon),1,1)!=9) or  (length(trim(mobil_persona_regala)) = 9 and substr(trim(mobil_persona_regala),1,1)!=9))';
  $where=' where (substr(trim(telefon),1,1)!=9 or substr(trim(mobil_persona_regala),1,1)!=9)';
  ...
  $sql='
  SELECT pilot,telefon,persona_regala,mobil_persona_regala from eventscantabria '.$where.'
  ';
  $result=mysqli_query($link,$sql);
}
else 
