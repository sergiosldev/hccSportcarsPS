...
if($_REQUEST['tipus']=='_bferrari_' || $_REQUEST['tipus']=='_blamborghini_'  || $_REQUEST['tipus']=='formula')
  $transform = 2;
//mts 24012013
...
// fi graelles dobles
	...
	{
	$info.='
        <td  style="width:100px;font-size:10px;vertical-align:middle;border-top:1px solid #000000;border-bottom:1px solid #000000;'.$border_style.'" class="borderg " align="left" > '.utf8_encode($sobservaciones).'<br /><strong>'.$r['num_vueltas'].' vueltas.</strong> </td>';
...
<table border="1" cellspacing="0" cellpadding="0" style="width:1200px;padding-top:10px;padding-right:5px;border-spacing:0 14px;">
	<tr>
		...
		<td width="250px" align="right" class="info extra" style="font-size:9px;vertical-align:middle;padding-right:100px;">
			<span>'.($_REQUEST['tipus']=='formula'?'Nº vueltas:':'Ruta:').'</span>
		</td>
	</tr>
</table>
');
