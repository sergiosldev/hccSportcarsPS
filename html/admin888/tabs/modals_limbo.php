<div style='display:none;float:left;width:20%;'>
  <div id='buscar_contact_limbo' style='text-align:left;padding:10px; background:#fff;'>
  	<fieldset>
   <FORM ACTION="#"  METHOD="GET" id="form_buscar_limbo" name="form_buscar_limbo"> 
    <table width="400px" >
		   <tr>    
		    ...
		    <td><INPUT TYPE="text" NAME="diab" id="diab" placeholder="yyyy-mm-dd">
			</td>
		    </tr>
			<tr>
		    ...
		    <td><br><INPUT TYPE="button" style="border:1px solid #7766aa" value="Busca" onclick="enviar_buscar_limbo();">
			</td>
		    </tr>
     </table>             
	</FORM>
