	...
	public function viewDetails()
	{
		...
		echo '
			<fieldset style="width: 400px">
				...
				<br />'.$this->l('Created on:').' '.Tools::displayDate($order->invoice_date, intval($cookie->id_lang), true).'
			</fieldset><br />';
		...
		<fieldset style="width: 400px">
			...
			if ($order->shipping_number)
				echo $this->l('Tracking number:').' <b>'.$order->shipping_number.'</b> (<a href="'.str_replace('@', $order->shipping_number, $carrier->url).'" target="_blank">'.$this->l('Track the shipment').'</a>)';
