...
var ajax_post = (function()
{
	...
	var load = function( url, querystring,callback, getResponseFn )
	{
		var async = !!callback;
	...
	return 	/** @lends CKEDITOR.ajax */ {
		 ...
		 *     } );
		 */
		load : function( url, querystring,callback )
		{
			return load( url, querystring, callback, getResponseText );
		}
	...
	function obtenirDadesForm_xx(formulari){
