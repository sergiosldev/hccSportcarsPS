...
//**  if(dia_sel!='')get_graella_sel(dia_sel)
  ...
  switch(t){
	...
	break;
	case '_bporsche_':
	   id_('tipus_img_sel').innerHTML='<span style="display:inline-block;float:left;position:relative;top:22px;left:32px;color:#ffffff;font-weight:bold;">Bautismo</span><img style="padding:4px;border:1px solid #000" width="100px" alt="" src="../../img/c/bporsche.jpg">';
	break;
	case '_corvette_':
		   id_('tipus_img_sel').innerHTML='<img style="padding:4px;border:1px solid #000" width="100px" alt="" src="../../img/c/corvette.jpg">';
		break;
	case '_bcorvette_':
		   id_('tipus_img_sel').innerHTML='<span style="display:inline-block;float:left;position:relative;top:22px;left:32px;color:#ffffff;font-weight:bold;">Bautismo</span><img style="padding:4px;border:1px solid #000" width="100px" alt="" src="../../img/c/bcorvette.jpg">';
		break;	
/*	case '_lotus_':
	   id_('tipus_img_sel').innerHTML='<img style="padding:4px;border:1px solid #000" width="100px" alt="" src="../../img/c/10.jpg">';
	break;*/
	case '_bferrari_':
     id_('tipus_img_sel').innerHTML='<span style="display:inline-block;float:left;position:relative;top:22px;left:32px;color:#ffffff;font-weight:bold;">Bautismo</span><img style="padding:4px;border:1px solid #000" width="100px" alt="" src="../../img/c/bferrari430.jpg">';	 
  break;
  case '_blamborghini_':
     id_('tipus_img_sel').innerHTML='<span style="display:inline-block;float:left;position:relative;top:22px;left:32px;color:#ffffff;font-weight:bold;">Bautismo</span><img style="padding:4px;border:1px solid #000" width="100px" alt="" src="../../img/c/blamborghini.jpg">';
  break;
  // BUGGY
  case '_buggy_':
...
function canvia_ciudad_sel(t) 
{
  ...
  var ciudades = new Array('barcelona','madrid','valencia','andalucia','cantabria','circuitovendrell','circuitomoradebre','circuitoandalucia','circuitovalencia','circuitosegovia','circuitozaragoza');

  for (var i = 0;i<ciudades.length;i++)
  {
	 ///alert(aux_t.toLowerCase()+'-'+ciudades[i]);
  ...
  if (ciudad_aux_sel.indexOf('circuito')!=-1)
  {
	var tmp=aux_t.split('circuito');
	if(tmp[1]=='moradebre') tmp[1]='Mora d\'Ebre';
	tmp='Circuito '+ tmp[1];
	id_('ciudad_info_p_sel').innerHTML =tmp;  
	tipus_ev_sel='formula';
  }
  //alert('seleccion calendario: '+v_mes+'-'+v_ano+'-'+ciudad_aux_sel+'-'+tipus_ev_sel);
  id_('calendari_sel').innerHTML = crida_sel(v_mes_sel, v_ano_sel,ciudad_aux_sel,tipus_ev_sel);
  
  //**if(dia_sel!='')get_graella_sel(dia_sel)

  /* mts 21042012, modif para que nos actualice la imagen de ferrari seg�n la ciudad seleccionada */
  if (ciudad_aux_sel.indexOf('circuito')!=-1)
  {
		id_('tipus_img_sel').innerHTML='<img style="padding:4px;border:1px solid #000" width="100px" alt="" src="../../img/c/formula.jpg">';
		$('#boton_vehiculos').hide();
  }
  else 
  {
