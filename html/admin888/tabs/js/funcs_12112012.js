function canvia_tipus(t) {
  ...
  switch(t){
	...
	break;
	case '_bferrari_':
        id_('tipus_img').innerHTML='<img style="padding:4px;border:1px solid #000" width="100px" alt="" src="../../24/ferrari-360-modena-f1.jpg">';
  break;
  case '_blamborghini_':
        id_('tipus_img').innerHTML='<img style="padding:4px;border:1px solid #000" width="100px" alt="" src="../../26/lamborghini-gallardo.jpg">';
  break;
  // BUGGY
  case '_buggy_':
        id_('tipus_img').innerHTML='<img style="padding:4px;border:1px solid #000" width="100px" alt="" src="../../22/buggies.jpg">';
