function canvia_tipus(t) {
  ...
  var clase='';
  var tipus_arr = new Array('ferrari','_bferrari_','lamborghini','_blamborghini_','_buggy_','_porsche_','_lotus_');
  for (var i = 0;i<tipus_arr.length;i++)
  {
	if (tipus_arr[i]=='ferrari' ||tipus_arr[i]=='_bferrari_') clase='boton_mediano';
  ...
  switch(t){
	...
	break;
	case '_bferrari_':
     id_('tipus_img').innerHTML='B Ferrari';
  break;
  case '_blamborghini_':
     id_('tipus_img').innerHTML='B Lamborghini';
  break;
  // BUGGY
  case '_buggy_':
