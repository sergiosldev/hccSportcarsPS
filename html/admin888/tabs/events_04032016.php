...
<script type="text/javascript" src="tabs/js/funcs_fechas.js?id=<?php echo(rand(0,50000));?>"></script>
...
*/
	  ...
	  k=k-1;	
	  document.getElementById('form_pdf2').action= '<?php echo $base_scripts ?>concatenar_pdf.php?num_listados='+k+ale;                       
	  document.getElementById('form_pdf2').submit();
...
function marca_reserva_especial(id,tipusev,m) 
{
   var ale='&gg'+(Math.floor(Math.random()*50000))+'=1';   
   r=ajax.load('<?php echo $base_scripts ?>ajax.php?marca_especial='+id+'&ciudad='+ciudad_aux+'&mark='+m+'&tipus='+tipusev+ale);
   get_graella(dia_sel);
}
