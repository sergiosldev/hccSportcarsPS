...
class AdminCustomers extends AdminTab
{
	public function __construct()
	{
		...
		$this->_modCustomerBoolean(); // Accions get extres
		...
		'phone' => array('title' => $this->l('Telefono'), 'width' => 60),
		//'age' => array('title' => $this->l('Age'), 'width' => 30, 'search' => false),
		'active' => array('title' => $this->l('Enabled'), 'width' => 25, 'align' => 'center', 'active' => 'status', 'type' => 'bool', 'orderby' => false),
		'Documentos' => array('title' => $this->l('Documentos Enviados'), 'width' => 25, 'align' => 'center', 'active' => 'Documentos_mod', 'type' => 'bool', 'orderby' => false),
		
		'valido' => array('title' => $this->l('Valido'), 'width' => 25, 'align' => 'center', 'active' => 'Valido_mod', 'type' => 'bool', 'orderby' => false),
		...
		'password' => array('title' => $this->l('password'), 'width' => 60)
	...
	public function _getCustomer()
	  {
		...
		WHERE id_customer like "'.$_GET['id_customer'].'"';
		//die($sql);
	...
	public function _modCustomerBoolean()
	  {
		...
		//die($sql);
	  	$re=Db::getInstance()->Execute($sql);
		$r=mysql_fetch_assoc($re);
		if(isset($_GET['Documentos_mod']))
		  {
		  $aux=0;	
		  if($r['Documentos']=='0')$aux=1;
		  $this->_setCamp('Documentos',$aux);  	
		  }
		}
	}
	
	public function _setCamp($c,$v)
	  {
	  	$sql='UPDATE
	...
	// calcula dies entre dates  
	public function quants_dias($data1, $data2){ 
         return round((strtotime($data1) - 
           strtotime($data2)) / (24 * 60 * 60), 0); 
    }
	/*
	 * Es posa inactiu 15 dies abans del pagament, es calcula
	 * dies entre data alta i actual 
	 * Si actiu i ultimo pago + 20 dies  posar inactiu
	 * Quan es paga es recull la data i es fa process
	 * 
	 * es treu dies de dies_totals_desde_incripcio%dies_totals_data
	 * es fa modul
	 */
	...
	public function postProcess()
	{
		...
		$pagats=$c['pagats'];
			...
			$this->_setCamp('pagats',$ultimo_pago.','.$pagats);
			$this->_setCamp('ultimo_pago',date('Y-m-j'));
		}
