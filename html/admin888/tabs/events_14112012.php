...
// alert(tipus_ev)   
  window.location="http://lon.motorclubexperience.com/admin888/tabs/scripts/descargar_mails.php?mails_bcn=1"
}

function descarga_mails_madrid(){
  window.location="http://lon.motorclubexperience.com/admin888/tabs/scripts/descargar_mails.php?mails_mad=1"
}

function descarga_mails_valencia(){
  window.location="http://lon.motorclubexperience.com/admin888/tabs/scripts/descargar_mails.php?mails_val=1"
}

function descarga_mails_andalucia(){
  window.location="http://lon.motorclubexperience.com/admin888/tabs/scripts/descargar_mails.php?mails_and=1"
}
