...
function get_graella_organizadores_20km7km() {
  ...
  document.getElementById('gf_pdf').value=r;   
  document.getElementById('horas_pdf').value='';
  //_h_;
 ...
 //alert(document.getElementById('horas_pdf2').value);
  ...
  //document.getElementById('form_pdf').action= '<?php echo $base_scripts ;?>graella_organizadores.php?data='+dia+'&ciudad='+ciudad_aux+'&tipus='+tipus_ev+'<?php echo $f; ?>'+ale;
  alert("SEMAFOR 2");
  alert(document.getElementById('gf_pdf3').value);
...
<!-- PDF -->
<form target="_blank" id="form_pdf" action="<?php echo $base_scripts; ?>generar_pdf_organizadores.php" method="POST" >
    <input type="hidden" name="hf2" id="hf_pdf2"/>
    <input type="hidden" name="gf2" id="gf_pdf2"/>
    <input type="hidden" name="horas2" id="horas_pdf2"/>
</form>

<form target="_blank" id="form_pdf2" action="<?php echo $base_scripts; ?>generar_pdf_organizadores.php" method="POST" >
    <input type="hidden" name="test1" id="hf_pdf3" value="test1"/>
    <input type="hidden" name="test2" id="gf_pdf3" value="test2"/>
    <input type="hidden" name="test3" id="horas_pdf3" value="test3"/>
    <input type="submit"/>
</form>
