		...
		'.($obj->id ? '<input type="hidden" name="id_'.$this->table.'" value="'.$obj->id.'" />' : '').'
			<fieldset class="width3"><legend><img src="../img/admin/world.gif" />'.$this->l('States').'</legend>
				...
				<div class="margin-form">
					...
					<p>
						'.$this->l('1 to 5 letter ISO code').' <br />
						(<a href="http://simple.wikipedia.org/wiki/List_of_U.S._states" target="_blank">'.$this->l('official USA states list here').'</a>) <br />
						(<a href="http://en.wikipedia.org/wiki/Prefectures_of_Japan" target="_blank">'.$this->l('official Japan prefectures list here').'</a>)
					</p>
				</div>
