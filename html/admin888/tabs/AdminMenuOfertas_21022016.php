...
include_once dirname(__FILE__).'/scripts/config_events.php';
...
function edita_menu_oferta(id_oferta,periodo,tipo,cliente_especial,motorclub,dreamcars,hcc,periodo_automatico)  
{
  ...
  if (motorclub != undefined)
	{
		if (motorclub==1) id_('menu_motorclub').value=1;
		else id_('menu_motorclub').value=0;
	}
  
   if (dreamcars != undefined)
	{
		if (dreamcars==1) id_('menu_dreamcars').value=1;
		else id_('menu_dreamcars').value=0;
	}
