...
function edita_menu_oferta(id_oferta,periodo)  
{
...
//English=en
        ...
        function tinyMCEInitCupones(element)
        {
            $().ready(function() {
                $(element).tinymce({
                    // Location of TinyMCE script
...
//English=en
                    // Theme options
                    theme_advanced_buttons1 : "bold,italic,underline,strikethrough,|,search,replace,|,bullist,numlist,|,outdent,indent,|,undo,redo,|,newdocument,",
                    theme_advanced_toolbar_location : "top",
                    theme_advanced_toolbar_align : "left",
                    theme_advanced_statusbar_location : "bottom",
                    theme_advanced_resizing : false,
                    content_css : "'.__PS_BASE_URI__.'themes/'._THEME_NAME_.'/css/globalCupones.css",
                    document_base_url : "'.__PS_BASE_URI__.'",
                    width: "600", //582
                    height: "auto",
                    //font_size_style_values : "8pt, 10pt, 12pt, 14pt, 18pt, 24pt, 36pt",
        ...
        //tinyMCEInitCupones(\'textarea.rtec2\');
        </script>
        <style>
