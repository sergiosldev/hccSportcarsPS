...
?>
<script type="text/javascript" src="<?php echo(_BASE_URL_);?>admin888/tabs/js/sha.js"></script>
<script type="text/javascript" src="<?php echo(_BASE_URL_);?>admin888/tabs/js/funcs_fechas.js?id=<?php echo(rand(0,50000));?>"></script>


<script type="text/javascript" src="<?php echo(_BASE_URL_);?>admin888/tabs/js/funcs.js?id=<?php echo(rand(0,50000));?>"></script>    
<script type="text/javascript" src="<?php echo(_BASE_URL_);?>admin888/tabs/js/ajax_load.js"></script>   
<script type="text/javascript" src="<?php echo(_BASE_URL_);?>admin888/tabs/js/ajax_load_post.js"></script>   
<link rel="stylesheet" type="text/css" href="<?php echo(_BASE_URL_);?>admin888/tabs/css/style.css">   
<link rel="stylesheet" type="text/css" href="<?php echo(_BASE_URL_);?>admin888/tabs/css/botones_menu.css">   
<link media="screen" rel="stylesheet" href="<?php echo(_BASE_URL_);?>admin888/tabs/modal/colorbox.css" />            

<!--<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.4.4/jquery.min.js"></script>       -->
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.4.4/jquery.min.js"></script>
<!--<script src="/js/jquery/jquery-1.2.6.pack.js" type="text/javascript"></script>-->
<!--<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>-->
<script src="tabs/modal/colorbox_old/jquery.colorbox.js"></script>
...
<div>
  ...
  include dirname(__FILE__).'/scripts/formulario_listado_telefonos_formula.php';           
  include dirname(__FILE__).'/scripts/formulario_listado_emails.php';  

  include dirname(__FILE__).'/scripts/formulario_listado_emails_formula.php';  
...
function esborra(id,id_ev,usuario_borrado) // quan esborres pilot
{
  var texto='';
  ...
  if (confirm(texto)) {
    var ale='&gg'+(Math.floor(Math.random()*50000))+'=1'         
    r = ajax.load('<?php echo $base_scripts ?>ajax.php?esborra=' + id + '&id_event=' + id_ev + '&ciudad='+ciudad_aux+'&tipus=' + tipus_ev+'&usuario_borrado='+usuario_borrado+ale);
    //alert(r);
    get_graella(dia_sel);
    //id_('calendari').innerHTML = crida(v_mes, v_ano);
  }
...
function get_graella(dia) {
  ...
  var r=ajax.load('<?php echo $base_scripts ?>graella.php?data='+dia+'&ciudad='+ciudad_aux+'&tipus='+tipus_ev+'<?php echo $f; ?>'+'&perfil=<?php echo($perfil);?>'+'&usuario=<?php echo($cookie->email);?>'+ale);  
...
function get_graella_organizadores(_h_) {
  ...
  document.getElementById('gf2').value=r;   
  document.getElementById('horas2').value=_h_;
 //alert(document.getElementById('gf').value); 
  ...
  document.getElementById('form_pdf_orga').submit();
}
...
function get_graella_organizadores_20km7km() {
  ...
  //_h_;
 //alert(document.getElementById('gf_pdf2').value); 
 //alert(document.getElementById('horas_pdf2').value);
  //alert(document.getElementById('gf_pdf').value);
  //document.getElementById('form_pdf').action= '<?php echo $base_scripts ;?>graella_organizadores.php?data='+dia+'&ciudad='+ciudad_aux+'&tipus='+tipus_ev+'<?php echo $f; ?>'+ale;
  //document.getElementById('form_pdf2').action= '<?php echo $base_scripts ;?>generar_pdf_organizadores.php';
  //alert(document.form_pdf_orga.gf2.value);
...
function edita(id) //quan esborres pilot
{
  var ale='&gg'+(Math.floor(Math.random()*50000))+'=1'
  id_('msg_error').innerHTML='';
  document.getElementById('form_alta_res').reset();
  //$(".form_").colorbox({width:"60%", inline:true, href:"#form_",open:true});
  $.colorbox({width:"60%", inline:true, href:"#form_alta_res",open:true});
  //id_('alta').style.display="block"
  r=ajax.load('<?php echo $base_scripts ?>ajax.php?id_edita='+id+ale+'&ciudad='+ciudad_aux+'&tipus='+tipus_ev);
  //alert(r);
  eval(r);
  id_('edicio11').value='true';
}
...
function envia_formulari() {
    var ale='&gg'+(Math.floor(Math.random()*50000))+'=1'    
    var dades=obtenirDadesForm('form_alta_res');
	//alert(dades);
	var plazas=0;
...
function descarga_mails_dia(){
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_mails.php?mails_day="+dia_sel+"&ciudad="+ciudad_aux+"&tipus="+tipus_ev
}
function descarga_mails_dia_conf(){
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_mails.php?mails_day_conf="+dia_sel+"&ciudad="+ciudad_aux+"&tipus="+tipus_ev
}
function descarga_mails_all(tipoc,fdesde,fhasta){
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_mails.php?mails_all=1&tipoc="+tipoc+"&fdesde="+fdesde+"&fhasta="+fhasta;
}

function descarga_mails_barcelona(tipoc,fdesde,fhasta){
// alert(tipus_ev)   
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_mails.php?mails_bcn=1&tipoc="+tipoc+"&fdesde="+fdesde+"&fhasta="+fhasta;
}

function descarga_mails_madrid(tipoc,fdesde,fhasta){
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_mails.php?mails_mad=1&tipoc="+tipoc+"&fdesde="+fdesde+"&fhasta="+fhasta;
}

function descarga_mails_valencia(tipoc,fdesde,fhasta){
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_mails.php?mails_val=1&tipoc="+tipoc+"&fdesde="+fdesde+"&fhasta="+fhasta;
}

function descarga_mails_andalucia(tipoc,fdesde,fhasta){
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_mails.php?mails_and=1&tipoc="+tipoc+"&fdesde="+fdesde+"&fhasta="+fhasta;
}

function descarga_mails_cantabria(tipoc,fdesde,fhasta){
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_mails.php?mails_can=1&tipoc="+tipoc+"&fdesde="+fdesde+"&fhasta="+fhasta;
}

function descarga_mails_circuito_andalucia(fdesde,fhasta){
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_mails_circuito.php?mails_and=1&fdesde="+fdesde+"&fhasta="+fhasta;
}
function descarga_mails_circuito_valencia(fdesde,fhasta){
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_mails_circuito.php?mails_val=1&fdesde="+fdesde+"&fhasta="+fhasta;
}
function descarga_mails_circuito_segovia(fdesde,fhasta){
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_mails_circuito.php?mails_seg=1&fdesde="+fdesde+"&fhasta="+fhasta;
}
function descarga_mails_circuito_vendrell(fdesde,fhasta){
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_mails_circuito.php?mails_ven=1&fdesde="+fdesde+"&fhasta="+fhasta;
}
function descarga_mails_circuito_moradebre(fdesde,fhasta){
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_mails_circuito.php?mails_mor=1&fdesde="+fdesde+"&fhasta="+fhasta;
}

function descarga_mails_circuito_zaragoza(fdesde,fhasta){
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_mails_circuito.php?mails_zar=1&fdesde="+fdesde+"&fhasta="+fhasta;
}
...
/** Fórmula **/
function descarga_emails_sel_formula_vendrell(fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
  var email_siguiente='';             
  var nemails_total=0;
  <?php global $cookie; ?>	
  var usuario='<?php echo($cookie->email);?>'; 
  window.location="<?php echo($root);?>/admin888/tabs/scripts/descargar_mails_seleccion_formula.php?emails_circuito_ven=1&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+"&sel_cliente="+sel_cliente+"&marcar_envio=&nemails_total="+nemails_total;                                                   

}

function descarga_emails_sel_formula_moradebre(fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
  var email_siguiente='';             
  var nemails_total=0;
  <?php global $cookie; ?>	
  var usuario='<?php echo($cookie->email);?>'; 
  window.location="<?php echo($root);?>/admin888/tabs/scripts/descargar_mails_seleccion_formula.php?emails_circuito_mor=1&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+"&sel_cliente="+sel_cliente+"&marcar_envio=&nemails_total="+nemails_total;                                                   

}

function descarga_emails_sel_formula_andalucia(fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
  var email_siguiente='';             
  var nemails_total=0;
  <?php global $cookie; ?>	
  var usuario='<?php echo($cookie->email);?>'; 
  window.location="<?php echo($root);?>/admin888/tabs/scripts/descargar_mails_seleccion_formula.php?emails_circuito_and=1&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+"&sel_cliente="+sel_cliente+"&marcar_envio=&nemails_total="+nemails_total;                                                   

}

function descarga_emails_sel_formula_segovia(fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
  var email_siguiente='';             
  var nemails_total=0;
  <?php global $cookie; ?>	
  var usuario='<?php echo($cookie->email);?>'; 
  window.location="<?php echo($root);?>/admin888/tabs/scripts/descargar_mails_seleccion_formula.php?emails_circuito_seg=1&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+"&sel_cliente="+sel_cliente+"&marcar_envio=&nemails_total="+nemails_total;                                                   

}

function descarga_emails_sel_formula_zaragoza(fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
  var email_siguiente='';             
  var nemails_total=0;
  <?php global $cookie; ?>	
  var usuario='<?php echo($cookie->email);?>'; 
  window.location="<?php echo($root);?>/admin888/tabs/scripts/descargar_mails_seleccion_formula.php?emails_circuito_zar=1&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+"&sel_cliente="+sel_cliente+"&marcar_envio=&nemails_total="+nemails_total;                                                   

}


function descarga_emails_sel_formula_all(fdesde,fhasta,hdesde,hhasta,sel_cliente)               
{
  var email_siguiente='';             
  <?php global $cookie; ?>	
  var usuario='<?php echo($cookie->email);?>'; 

  window.location="<?php echo($root);?>/admin888/tabs/scripts/descargar_mails_seleccion_formula.php?emails_all=1&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+"&sel_cliente="+sel_cliente+"&marcar_envio=&nemails_total="+nemails_total;                                                     
}
...
{
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_telefonos.php?telefons_all=1&tipo_ferrari="+tipo_ferrari+"&tipo_lambo="+tipo_lambo+"&tipo_porsche="+tipo_porsche+"&tipo_corvette="+tipo_corvette+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;                                                                                                                            
}
...
{
	window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_telefonos.php?telefons_bcn=1&tipo_ferrari="+tipo_ferrari+"&tipo_lambo="+tipo_lambo+"&tipo_porsche="+tipo_porsche+"&tipo_corvette="+tipo_corvette+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;                           
}
...
{
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_telefonos.php?telefons_mad=1&tipo_ferrari="+tipo_ferrari+"&tipo_lambo="+tipo_lambo+"&tipo_porsche="+tipo_porsche+"&tipo_corvette="+tipo_corvette+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;                                                     
}
...
{
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_telefonos.php?telefons_val=1&tipo_ferrari="+tipo_ferrari+"&tipo_lambo="+tipo_lambo+"&tipo_porsche="+tipo_porsche+"&tipo_corvette="+tipo_corvette+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;
}
...
{
  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_telefonos.php?telefons_and=1&tipo_ferrari="+tipo_ferrari+"&tipo_lambo="+tipo_lambo+"&tipo_porsche="+tipo_porsche+"&tipo_corvette="+tipo_corvette+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;
}
...
{
	  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_telefonos.php?telefons_can=1&tipo_ferrari="+tipo_ferrari+"&tipo_lambo="+tipo_lambo+"&tipo_porsche="+tipo_porsche+"&tipo_corvette="+tipo_corvette+"&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;
}

function descarga_telefonos_formula_vendrell(fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
	  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_telefonos_formula.php?telefons_circuito_ven=1&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;
}

function descarga_telefonos_formula_moradebre(fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
	  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_telefonos_formula.php?telefons_circuito_mor=1&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;
}

function descarga_telefonos_formula_segovia(fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
	  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_telefonos_formula.php?telefons_circuito_seg=1&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;
}

function descarga_telefonos_formula_andalucia(fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
	  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_telefonos_formula.php?telefons_circuito_and=1&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;
}

function descarga_telefonos_formula_valencia(fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
	  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_telefonos_formula.php?telefons_circuito_val=1&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;
}

function descarga_telefonos_formula_zaragoza(fdesde,fhasta,hdesde,hhasta,sel_cliente)
{
	  window.location="<?php echo(_BASE_URL_);?>/admin888/tabs/scripts/descargar_telefonos_formula.php?telefons_circuito_zar=1&fdesde="+fdesde+"&fhasta="+fhasta+"&hdesde="+hdesde+"&hhasta="+hhasta+'&sel_cliente='+sel_cliente;
}
...
function marca_event(id,tipusev,m) {
   ...
   if (m==1)
   {
	   if (confirm('Desea marcar el cliente como cupón ya canjeado?')) 
	   {

		   //Canjear cupon = 1;
		r=ajax.load('<?php echo $base_scripts ?>ajax.php?marca_event='+id+'&ciudad='+ciudad_aux+'&mark='+m+'&tipus='+tipusev+ale+'&canje=1');
		alert(r);
		var ok=/OK/;
		if (ok.test(r)) { // recarrega graella
		   //alert(r);
  ...
  {
	   if (confirm('Desea desmarcar el cliente como cupón ya canjeado?')) 
	   {
		 id_('frm_validar_password').reset();
		 id_('archivo_operacion').value= 'ajax.php'
		 id_('archivo_retorno').value = 'events.php';
		 ...
		 id_('datos').value = 'marca_event='+id+'&ciudad='+ciudad_aux+'&mark='+m+'&tipus='+tipusev+'&canje=0';
		 //$.noConflict();	
		 $.colorbox({width:"42%", inline:true, href:"#form_validar_password",open:true}); 
	  }
  }  
...
function marca_bloqueado_solicitar(id,tipusev,m) {  //Bloqueado pero con posibilidad de solicitar hora.
   var ale='&gg'+(Math.floor(Math.random()*50000))+'=1';
   if (m==1)
   {
	   if (confirm('Desea marcar el cliente como bloqueado con posiblidad de solicitar que le habran una hora?')) 
	   {
  ...
  {
	   if (confirm('Desea desmarcar el cliente como bloqueado con posiblidad de solicitar que le habran una hora?')) 
	   {
		 id_('frm_validar_password').reset();
		 id_('archivo_operacion').value= 'ajax.php'
		 id_('archivo_retorno').value = 'events.php';
...
function marca_reserva_especial(id,tipusev,m,pciudad) 
{
   var ciudad_
   ...
   if (ciudad_=='barcelona') ciudad_='';
   var ale='&gg'+(Math.floor(Math.random()*50000))+'=1';   
   r=ajax.load('<?php echo $base_scripts ?>ajax.php?marca_especial='+id+'&ciudad='+ciudad_+'&mark='+m+'&tipus='+tipusev+ale);
   get_graella(dia_sel);
}
...
<!-- PDF -->
<form target="_blank" id="form_pdf_orga" name="form_pdf_orga" action="<?php echo $base_scripts; ?>generar_pdf_organizadores.php" method="POST" >
    <input type="hidden" name="hf2" id="hf2"/>
    <input type="hidden" name="gf2" id="gf2"/>
    <input type="hidden" name="horas2" id="horas2"/>
...
function abrir_listado_emails (formula)    
{
  	...
  	if (formula==0)
		...
		$.colorbox({width:"95%",height:"400px", inline:true, href:"#form_listado_emails_formula",open:true});             		     
...
function abrir_listado_telefonos (formula)    
{
  	if (formula==0)
		$.colorbox({width:"95%",height:"400px", inline:true, href:"#form_listado_telefonos",open:true});             		     
	else
		$.colorbox({width:"95%",height:"400px", inline:true, href:"#form_listado_telefonos_formula",open:true});             		     
...
?>   
<!-- <script type="text/javascript" src="tabs/js/jquery-1.11.3.min.js"></script>  -->
<!-- <script type="text/javascript" src="tabs/js/enctype.js"></script> -->
