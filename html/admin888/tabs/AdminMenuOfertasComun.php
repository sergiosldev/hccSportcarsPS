...
<fieldset>
    ...
    <?php if ($tipo=='ofertas_online') 
    {?>
    <a href="javascript:vista('clientes')" class="boton_menu" id="lista_clientes_sel">Ver Clientes</a> 
    <?php 
    }else { ?>
    <a href="javascript:vista('alta_distribuidor')" class="boton_menu" id="editar_distribuidor">Alta Distribuidor</a> 
    <a href="javascript:vista('distribuidores')" class="boton_menu" id="lista_distribuidores_sel">Ver Distribuidores</a> 
    <?php } ?>
...
function mostrar_ocultar_elementos(elemento,tipo)
{
    ...
    else if (tipo=='cupones_alfa_online')
    {
        formularios['ofertas'] = new Array('mostrar_lista_ofertas','ocultar_lista_ofertas');
        formularios['ofertas_creadas'] = new Array('mostrar_lista_ofertas','dummy');
        formularios['alta_oferta']= new Array('mostrar_form_oferta','ocultar_form_oferta');
        formularios['validar_cupon_oferta'] = new Array('mostrar_form_busqueda_cupon_oferta','ocultar_form_busqueda_cupon_oferta');
        formularios['k1']= new Array('mostrar_form_activar_oferta','ocultar_form_activar_oferta');
        formularios['k2']= new Array('mostrar_form_distribuidores_oferta','ocultar_form_distribuidores_oferta');  
        formularios['distribuidores']= new Array('mostrar_lista_distribuidores','ocultar_lista_distribuidores');
        ...
        selectores['alta_oferta']='editar';
        selectores['validar_cupon_oferta']='validar_cupon_oferta';
        selectores['distribuidores']='lista_distribuidores_sel';
        selectores['alta_distribuidor']='editar_distribuidor';
...
function cambiar_posicion_oferta_creada(posicion,direccion,id_oferta)
  {
    ...
    dades += '&posicion='+posicion;
    dades += '&direccion='+direccion;
    var r=ajax.load('<?php echo($base_scripts);?>ajax_ofertas_bd.php?reposicionar_creada=1&'+dades+aleatorio);
    //alert(r);       
    get_lista_ofertas_creadas();
  }  
...
//alert(iid+indice+'-'+id_('idofertas'+indice).value);
    if(amount < 0){
        ...
        var r=ajax.load('<?php echo($base_scripts);?>ajax_ofertas_bd.php?marcar_oferta_caducada=1&id_oferta='+id_('idofertas'+indice).value+'&id_oferta_hist='+id_('idofertash'+indice).value+'&cliente_especial='+cliente_especial);
...
function get_lista_ofertas_creadas(tipo)
   {
