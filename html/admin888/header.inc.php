...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $iso; ?>" lang="<?php echo $iso; ?>">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="<?php echo(_BASE_URL_);?>js/jquery/datepicker/datepicker.css" />
		<link type="text/css" rel="stylesheet" href="<?php echo(_BASE_URL_);?>modules/gridextjs/extjs/resources/css/ext-all.css" />
		<link type="text/css" rel="stylesheet" href="<?php echo(_BASE_URL_);?>css/admin.css" />
		...
		<script type="text/javascript" src="<?php echo(_BASE_URL_);?>js/admin.js"></script>
		<script type="text/javascript" src="<?php echo(_BASE_URL_);?>js/toggle.js"></script>
		<script type="text/javascript" src="<?php echo(_BASE_URL_);?>js/tools.js"></script>
		<script type="text/javascript" src="<?php echo(_BASE_URL_);?>js/ajax.js"></script>
		<link rel="shortcut icon" href="<?php echo(_BASE_URL_);?>img/favicon.ico" /> 
	...
	<body>
		<div id="container">
			...
			if (file_exists(PS_ADMIN_DIR.'/../install'))
				echo '<div style="background-color: #FFEBCC;border-bottom: 1px solid #F90;border-top: 1px solid #F90;line-height: 20px;margin: 10px 0px 0px;padding: 10px 20px;">'
				.translate('For security reasons, you have to:').' '.
