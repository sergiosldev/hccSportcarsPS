...
if (isset($_GET['ajaxProductManufacturers']))
{
	...
	if ($manufacturers)
	{
		...
		foreach ($manufacturers AS $manufacturer)
			$jsonArray[] = '{"optionValue": "'.$manufacturer['id_manufacturer'].'", "optionDisplay": "'.str_replace(array("\r","\n",), '', addslashes($manufacturer['name'])).'"}';
...
if (isset($_GET['ajaxProductSuppliers']))
{
	...
	if ($suppliers)
	{
		...
		foreach ($suppliers AS $supplier)
			$jsonArray[] = '{"optionValue": "'.$supplier['id_supplier'].'", "optionDisplay": "'.str_replace(array("\r","\n",), '', addslashes($supplier['name'])).'"}';
		die('['.implode(',', $jsonArray).']');
	}
}
